...
def calculate_penetration_cost(hand_verts, hand_normals, object_verts, object_normals, is_thin, contact_norm_method=0, allowable_pen=0.002):
    """
...
def mesh_is_thin(object_id, device):
    ...
    thins = ['C25001', 'C20001', 'S20001', 'S20005', 'S20021', 'S20022', 'C40001', 'C35001', 'Y35037']

    B = len(object_id)
    is_thin = torch.zeros(B, dtype=torch.float, device=device)
    for t in thins:
        is_thin[object_id == t] = 1
